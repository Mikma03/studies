...
\definecolor{gray75}{gray}{0.75}
\newcommand{\hsp}{\hspace{20pt}}
\addto\captionspolish{ % Add this line to use Polish captions
  \renewcommand{\chaptername}{Slajd}
}
\titleformat{\chapter}[hang]{\Huge\bfseries}{\thechapter\hsp\textcolor{gray75}{|}\hsp}{0pt}{\Huge\bfseries}
...
\AtBeginDocument{%
\renewcommand*\figurename{Rysunek} % zmiana nazwy rysunku - polski jezyk
\renewcommand*\tablename{Tabela} % zmiana nazwy tabeli - polski jezyk
}
\AtBeginDocument{%
